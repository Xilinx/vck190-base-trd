...
proc create_root_design { parentCell } {
  ...
  set rst_processor_pl_333Mhz [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset rst_processor_pl_333Mhz ]
  ...
  connect_bd_net -net ${::PS_INST}_pl_resetn0 [get_bd_pins ${::PS_INST}/pl0_resetn] [get_bd_pins rst_processor_pl_333Mhz/ext_reset_in] -boundary_type upper
  ...
  connect_bd_net -net clk_wiz_clk_out3 [get_bd_pins ${::NOC_INST_0}/aclk9] [get_bd_pins axi_perf_mon_0/core_aclk] -boundary_type upper
  ...
  connect_bd_net -net rst_processor_pl_200Mhz_peripheral_aresetn [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins rst_processor_pl_200Mhz/peripheral_aresetn] -boundary_type upper
