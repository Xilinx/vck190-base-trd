...
wire   [0:0] and_ln319_fu_317_p2;
reg    ap_condition_exit_pp0_iter0_stage1;
wire    ap_loop_exit_ready;
reg    ap_ready_int;
wire   [1:0] j_read_reg_416;
wire    ap_block_state1_pp0_stage0_iter0;
wire    ap_block_state3_pp0_stage0_iter1;
wire    ap_block_pp0_stage0_11001;
wire  signed [32:0] conv_i_i1068_cast_fu_227_p1;
reg  signed [32:0] conv_i_i1068_cast_reg_422;
reg   [12:0] p1_V_1_reg_427;
wire   [12:0] p1_V_fu_269_p2;
reg   [12:0] p1_V_reg_448;
wire    ap_block_pp0_stage1_11001;
wire   [31:0] n1_V_fu_323_p2;
reg   [31:0] n1_V_reg_456;
reg   [23:0] minValue_V_0_read_reg_461;
reg   [23:0] minValue_V_1_read_reg_466;
reg   [23:0] minValue_V_2_read_reg_471;
...
wire   [23:0] minValue_V_0_2_fu_337_p2;
reg   [23:0] minValue_V_2_2_fu_90;
reg   [23:0] minValue_V_2_3_fu_94;
wire    ap_block_pp0_stage0_01001;
wire    ap_block_pp0_stage1_01001;
wire   [31:0] rhs_fu_274_p5;
wire   [32:0] zext_ln225_36_fu_289_p1;
wire   [32:0] zext_ln225_fu_285_p1;
wire   [32:0] ret_fu_293_p2;
wire   [0:0] tmp_fu_304_p3;
wire   [0:0] icmp_ln1057_fu_299_p2;
wire   [0:0] xor_ln1057_fu_311_p2;
wire   [23:0] tmp_s_fu_329_p5;
reg    ap_done_reg;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        end else if (((j_read_reg_416 == 2'd0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        end else if (((j_read_reg_416 == 2'd1) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1) & (1'd1 == and_ln319_fu_317_p2))) begin
...
always @ (*) begin
    if (((1'd0 == and_ln319_fu_317_p2) & (1'b0 == ap_block_pp0_stage1_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((j_read_reg_416 == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((j_read_reg_416 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((j_read_reg_416 == 2'd1) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((j_read_reg_416 == 2'd1) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((~(j_read_reg_416 == 2'd1) & ~(j_read_reg_416 == 2'd0) & (1'b0 == ap_block_pp0_stage0_01001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((~(j_read_reg_416 == 2'd1) & ~(j_read_reg_416 == 2'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if (((1'd0 == and_ln319_fu_317_p2) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
assign and_ln319_fu_317_p2 = (xor_ln1057_fu_311_p2 & icmp_ln1057_fu_299_p2);
...
always @ (*) begin
    ap_condition_296 = (~(j_read_reg_416 == 2'd1) & ~(j_read_reg_416 == 2'd0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
assign icmp_ln1057_fu_299_p2 = ((ret_fu_293_p2 < conv_i_i1068_cast_reg_422) ? 1'b1 : 1'b0);

assign j_read_reg_416 = j;

assign minValue_V_0_2_fu_337_p2 = (tmp_s_fu_329_p5 + 24'd1024);
...
assign n1_V_fu_323_p2 = (rhs_fu_274_p5 + lhs_V_fu_78);

assign p1_V_fu_269_p2 = (p1_V_1_reg_427 + 13'd1);

assign ret_fu_293_p2 = (zext_ln225_36_fu_289_p1 + zext_ln225_fu_285_p1);

assign tmp_fu_304_p3 = p1_V_1_reg_427[32'd12];

assign xor_ln1057_fu_311_p2 = (tmp_fu_304_p3 ^ 1'd1);

assign zext_ln225_36_fu_289_p1 = rhs_fu_274_p5;
