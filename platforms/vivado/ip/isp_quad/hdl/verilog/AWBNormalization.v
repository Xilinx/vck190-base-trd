...
reg   [15:0] dst_rows_read_reg_84;
reg    ap_block_state1;
reg   [15:0] dst_cols_read_reg_89;
...
wire   [59:0] grp_AWBNormalizationkern_fu_66_dst_data_V_V_din;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (grp_AWBNormalizationkern_fu_66_ap_done == 1'b1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (grp_AWBNormalizationkern_fu_66_ap_done == 1'b1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    ap_block_state1_ignore_call10 = ((real_start == 1'b0) | (dst_cols_out_full_n == 1'b0) | (dst_rows_out_full_n == 1'b0) | (dst_cols_empty_n == 1'b0) | (dst_rows_empty_n == 1'b0) | (ap_done_reg == 1'b1));
end
