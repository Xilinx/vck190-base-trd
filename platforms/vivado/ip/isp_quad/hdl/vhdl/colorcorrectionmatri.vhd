...
architecture behav of colorcorrectionmatri is 
    ...
    signal grp_xfccmkernel_fu_44_ap_start : STD_LOGIC;
    signal grp_xfccmkernel_fu_44_ap_done : STD_LOGIC;
    signal grp_xfccmkernel_fu_44_ap_idle : STD_LOGIC;
    signal grp_xfccmkernel_fu_44_ap_ready : STD_LOGIC;
    signal grp_xfccmkernel_fu_44_p_src_mat_data_V_V_read : STD_LOGIC;
    signal grp_xfccmkernel_fu_44_p_dst_mat_data_V_V_din : STD_LOGIC_VECTOR (59 downto 0);
    signal grp_xfccmkernel_fu_44_p_dst_mat_data_V_V_write : STD_LOGIC;
    signal grp_xfccmkernel_fu_44_ap_start_reg : STD_LOGIC := '0';
...
begin
    grp_xfccmkernel_fu_44 : component xfccmkernel
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ap_start => grp_xfccmkernel_fu_44_ap_start,
        ap_done => grp_xfccmkernel_fu_44_ap_done,
        ap_idle => grp_xfccmkernel_fu_44_ap_idle,
        ap_ready => grp_xfccmkernel_fu_44_ap_ready,
        p_src_mat_data_V_V_dout => p_src_mat_data_V_V_dout,
        p_src_mat_data_V_V_empty_n => p_src_mat_data_V_V_empty_n,
        p_src_mat_data_V_V_read => grp_xfccmkernel_fu_44_p_src_mat_data_V_V_read,
        p_dst_mat_data_V_V_din => grp_xfccmkernel_fu_44_p_dst_mat_data_V_V_din,
        p_dst_mat_data_V_V_full_n => p_dst_mat_data_V_V_full_n,
        p_dst_mat_data_V_V_write => grp_xfccmkernel_fu_44_p_dst_mat_data_V_V_write,
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_continue = ap_const_logic_1)) then 
                    ap_done_reg <= ap_const_logic_0;
                elsif (((grp_xfccmkernel_fu_44_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_xfccmkernel_fu_44_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                grp_xfccmkernel_fu_44_ap_start_reg <= ap_const_logic_0;
            else
                if ((not(((ap_start = ap_const_logic_0) or (p_src_mat_cols_empty_n = ap_const_logic_0) or (p_src_mat_rows_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then 
                    grp_xfccmkernel_fu_44_ap_start_reg <= ap_const_logic_1;
                elsif ((grp_xfccmkernel_fu_44_ap_ready = ap_const_logic_1)) then 
                    grp_xfccmkernel_fu_44_ap_start_reg <= ap_const_logic_0;
                end if; 
            end if;
        end if;
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (p_src_mat_cols_empty_n = ap_const_logic_0) or (p_src_mat_rows_empty_n = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                height_reg_66 <= p_src_mat_rows_dout;
                trunc_ln_reg_71 <= p_src_mat_cols_dout(15 downto 1);
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, p_src_mat_rows_empty_n, p_src_mat_cols_empty_n, grp_xfccmkernel_fu_44_ap_done, ap_CS_fsm_state2)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state2 => 
                if (((grp_xfccmkernel_fu_44_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state2;
                end if;
    ...
    ap_done_assign_proc : process(ap_done_reg, grp_xfccmkernel_fu_44_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_xfccmkernel_fu_44_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    ap_ready_assign_proc : process(grp_xfccmkernel_fu_44_ap_done, ap_CS_fsm_state2)
    begin
        if (((grp_xfccmkernel_fu_44_ap_done = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_xfccmkernel_fu_44_ap_start <= grp_xfccmkernel_fu_44_ap_start_reg;
    p_dst_mat_data_V_V_din <= grp_xfccmkernel_fu_44_p_dst_mat_data_V_V_din;

    p_dst_mat_data_V_V_write_assign_proc : process(grp_xfccmkernel_fu_44_p_dst_mat_data_V_V_write, ap_CS_fsm_state2)
    begin
    ...
    p_src_mat_data_V_V_read_assign_proc : process(grp_xfccmkernel_fu_44_p_src_mat_data_V_V_read, ap_CS_fsm_state2)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state2)) then 
            p_src_mat_data_V_V_read <= grp_xfccmkernel_fu_44_p_src_mat_data_V_V_read;
        else 
