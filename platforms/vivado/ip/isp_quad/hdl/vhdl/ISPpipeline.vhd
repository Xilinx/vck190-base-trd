...
architecture behav of ISPpipeline is 
    ...
    signal AXIVideo2BayerMat_U0_bayer_mat_data_V_V_din : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal blackLevelCorrection_U0_p_Dst_data_V_V_din : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal badpixelcorrection_U0_p_dst_data_V_V_din : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal gaincontrol_U0_dst_data_V_V_din : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal demosaicing_U0_dst_mat_data_V_V_din : STD_LOGIC_VECTOR (59 downto 0);
    ...
    signal AWBhistogram_U0_src2_data_V_V_din : STD_LOGIC_VECTOR (59 downto 0);
    ...
    signal AWBNormalization_U0_dst_data_V_V_din : STD_LOGIC_VECTOR (59 downto 0);
    ...
    signal colorcorrectionmatri_U0_p_dst_mat_data_V_V_din : STD_LOGIC_VECTOR (59 downto 0);
    ...
    signal xf_QuatizationDither_U0_stream_out_data_V_V_din : STD_LOGIC_VECTOR (47 downto 0);
    ...
    signal ColorMat2AXIvideo_U0_m_axis_video_TDATA : STD_LOGIC_VECTOR (47 downto 0);
    signal ColorMat2AXIvideo_U0_m_axis_video_TVALID : STD_LOGIC;
    signal ColorMat2AXIvideo_U0_m_axis_video_TKEEP : STD_LOGIC_VECTOR (5 downto 0);
    signal ColorMat2AXIvideo_U0_m_axis_video_TSTRB : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal imgInput1_data_V_V_dout : STD_LOGIC_VECTOR (19 downto 0);
    ...
    signal lsc_out_data_V_V_dout : STD_LOGIC_VECTOR (59 downto 0);
    signal lsc_out_data_V_V_empty_n : STD_LOGIC;
    signal aecin_data_V_V_full_n : STD_LOGIC;
    signal aecin_data_V_V_dout : STD_LOGIC_VECTOR (47 downto 0);
    ...
    component start_for_badpixeRg6 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_gainconShg IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_demosaiThq IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_AWBhistUhA IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_xf_QuatVhK IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_ColorMaWhU IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_blackLeXh4 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_colorcoYie IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    imgInput1_data_V_V_U : component fifo_w20_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    imgInput2_data_V_V_U : component fifo_w20_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    bpc_out_data_V_V_U : component fifo_w20_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    gain_out_data_V_V_U : component fifo_w20_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    demosaic_out_data_V_s_U : component fifo_w60_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    impop_data_V_V_U : component fifo_w60_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    ltm_in_data_V_V_U : component fifo_w60_d4096_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    lsc_out_data_V_V_U : component fifo_w60_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    aecin_data_V_V_U : component fifo_w48_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_badpixeRg6_U : component start_for_badpixeRg6
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_gainconShg_U : component start_for_gainconShg
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_demosaiThq_U : component start_for_demosaiThq
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_AWBhistUhA_U : component start_for_AWBhistUhA
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_xf_QuatVhK_U : component start_for_xf_QuatVhK
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_ColorMaWhU_U : component start_for_ColorMaWhU
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_blackLeXh4_U : component start_for_blackLeXh4
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_colorcoYie_U : component start_for_colorcoYie
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
