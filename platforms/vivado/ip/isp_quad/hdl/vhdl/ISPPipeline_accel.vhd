...
architecture behav of ISPPipeline_accel is 
    ...
    "ISPPipeline_accel,hls_ip_2020_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcvc1902-vsva2197-1LP-e-S-es1,HLS_INPUT_CLOCK=6.600000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=10.309000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=74,HLS_SYN_DSP=0,HLS_SYN_FF=23519,HLS_SYN_LUT=27474,HLS_VERSION=2020_2}";
    ...
    signal grp_ISPpipeline_fu_109_m_axis_video_TDATA : STD_LOGIC_VECTOR (47 downto 0);
    signal grp_ISPpipeline_fu_109_m_axis_video_TKEEP : STD_LOGIC_VECTOR (5 downto 0);
    signal grp_ISPpipeline_fu_109_m_axis_video_TSTRB : STD_LOGIC_VECTOR (5 downto 0);
...
begin
    hist0_0_U : component ISPPipeline_accelZio
    generic map (
        DataWidth => 32,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    hist0_1_U : component ISPPipeline_accelZio
    generic map (
        DataWidth => 32,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    hist0_2_U : component ISPPipeline_accelZio
    generic map (
        DataWidth => 32,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    hist1_0_U : component ISPPipeline_accelZio
    generic map (
        DataWidth => 32,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    hist1_1_U : component ISPPipeline_accelZio
    generic map (
        DataWidth => 32,
        AddressRange => 1024,
        AddressWidth => 10)
    ...
    hist1_2_U : component ISPPipeline_accelZio
    generic map (
        DataWidth => 32,
        AddressRange => 1024,
        AddressWidth => 10)
