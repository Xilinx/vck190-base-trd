...
entity ISPPipeline_accelZio_ram is 
    generic(
...
architecture rtl of ISPPipeline_accelZio_ram is 
...
architecture arch of ISPPipeline_accelZio is
    component ISPPipeline_accelZio_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    ISPPipeline_accelZio_ram_U :  component ISPPipeline_accelZio_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
