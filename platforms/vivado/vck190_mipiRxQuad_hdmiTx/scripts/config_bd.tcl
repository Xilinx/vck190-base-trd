...
proc create_hier_cell_fmc_multicam_control { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 0 -to 0 fmc_multicam_poc1_int
  create_bd_pin -dir O -from 0 -to 0 fmc_multicam_poc2_en
  create_bd_pin -dir I -from 0 -to 0 fmc_multicam_poc2_int
  create_bd_pin -dir O -from 0 -to 0 fmc_muticam_max9286_pwdn_n
  create_bd_pin -dir O -from 0 -to 0 fmc_muticam_max9296_pwdn_n
  create_bd_pin -dir O -from 0 -to 0 fmc_mutlicam_max9286_fsync
  ...
  set fmc_multicam_gpi [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconcat fmc_multicam_gpi ]

  # Create instance: xlslice_26, and set properties
  set xlslice_26 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_26 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {26} \
   CONFIG.DIN_TO {26} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  set xlslice_27 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_27 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {27} \
   CONFIG.DIN_TO {27} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  set xlslice_28 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_28 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {28} \
   CONFIG.DIN_TO {28} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  set xlslice_29 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_29 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {29} \
   CONFIG.DIN_TO {29} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  set xlslice_30 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_30 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {30} \
   CONFIG.DIN_TO {30} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  set xlslice_31 [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice xlslice_31 ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {31} \
   CONFIG.DIN_TO {31} \
   CONFIG.DOUT_WIDTH {1} \
  ...
  connect_bd_intf_net -intf_net axi_iic_1_sensor_IIC [get_bd_intf_pins sensor_iic] [get_bd_intf_pins axi_iic_1_sensor/IIC]
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins axi_iic_1_sensor/S_AXI]

  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlslice_26/Din] -boundary_type upper
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlslice_27/Din] -boundary_type upper
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlslice_28/Din] -boundary_type upper
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlslice_29/Din] -boundary_type upper
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlslice_30/Din] -boundary_type upper
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins xlslice_31/Din] -boundary_type upper
  connect_bd_net -net In0_0_1 [get_bd_pins fmc_multicam_poc1_int] [get_bd_pins fmc_multicam_gpi/In0]
  connect_bd_net -net In1_0_1 [get_bd_pins fmc_multicam_poc2_int] [get_bd_pins fmc_multicam_gpi/In1]
  connect_bd_net -net axi_iic_1_sensor_iic2intc_irpt [get_bd_pins iic2intc_irpt] [get_bd_pins axi_iic_1_sensor/iic2intc_irpt]
  connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_pins s_axi_aclk] [get_bd_pins axi_iic_1_sensor/s_axi_aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axi_iic_1_sensor/s_axi_aresetn]
  connect_bd_net -net xlslice_26_Dout [get_bd_pins fmc_multicam_poc1_en] [get_bd_pins xlslice_26/Dout]
  connect_bd_net -net xlslice_27_Dout [get_bd_pins fmc_multicam_poc2_en] [get_bd_pins xlslice_27/Dout]
  connect_bd_net -net xlslice_28_Dout [get_bd_pins fmc_muticam_max9286_pwdn_n] [get_bd_pins xlslice_28/Dout]
  connect_bd_net -net xlslice_29_Dout [get_bd_pins fmc_muticam_max9296_pwdn_n] [get_bd_pins xlslice_29/Dout]
  connect_bd_net -net xlslice_30_Dout [get_bd_pins fmc_multicam_iic_mux_rst_n] [get_bd_pins xlslice_30/Dout]
  connect_bd_net -net xlslice_31_Dout [get_bd_pins fmc_mutlicam_max9286_fsync] [get_bd_pins xlslice_31/Dout]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: pipe_3
proc create_hier_cell_pipe_3 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_pipe_3() - Empty argument(s)!"}
     return
  }
  ...
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_ctrl_dm

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_ctrl_frm_b_wr

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_ctrl_ss
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins s_axi_ctrl_ss] [get_bd_intf_pins v_proc_ss_0/s_axi_ctrl]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins s_axi_ctrl_frm_b_wr] [get_bd_intf_pins v_frmbuf_wr_0/s_axi_CTRL]
  ...
  connect_bd_intf_net -intf_net s_axi_ctrl_dm_1 [get_bd_intf_pins s_axi_ctrl_dm] [get_bd_intf_pins ISPPipeline_accel_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net s_axis_video_1 [get_bd_intf_pins s_axis_video] [get_bd_intf_pins ISPPipeline_accel_0/s_axis_video]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_pins ISPPipeline_accel_0/ap_rst_n] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins v_proc_ss_0/aresetn_ctrl] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins v_frmbuf_wr_0/ap_rst_n] [get_bd_pins xlslice_3/Dout]

  # Restore current instance
  current_bd_instance $oldCurInst
}

# Hierarchical cell: pipe_2
proc create_hier_cell_pipe_2 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_pipe_2() - Empty argument(s)!"}
     return
  }
  ...
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins s_axi_ctrl_ss] [get_bd_intf_pins v_proc_ss_0/s_axi_ctrl]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins s_axi_ctrl_frm_b_wr] [get_bd_intf_pins v_frmbuf_wr_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net ISPPipeline_accel_1_m_axis_video [get_bd_intf_pins ISPPipeline_accel_0/m_axis_video] [get_bd_intf_pins v_proc_ss_0/s_axis]
  connect_bd_intf_net -intf_net s_axi_ctrl_dm_1 [get_bd_intf_pins s_axi_ctrl_dm] [get_bd_intf_pins ISPPipeline_accel_0/s_axi_CTRL]
  connect_bd_intf_net -intf_net s_axis_video_1 [get_bd_intf_pins s_axis_video] [get_bd_intf_pins ISPPipeline_accel_0/s_axis_video]
  connect_bd_intf_net -intf_net v_frmbuf_wr_0_m_axi_mm_video [get_bd_intf_pins m_axi_mm_video] [get_bd_intf_pins v_frmbuf_wr_0/m_axi_mm_video]
  connect_bd_intf_net -intf_net v_proc_ss_0_m_axis [get_bd_intf_pins v_frmbuf_wr_0/s_axis_video] [get_bd_intf_pins v_proc_ss_0/m_axis]
  ...
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins v_proc_ss_0/aclk_ctrl] -boundary_type upper
  connect_bd_net -net v_frmbuf_wr_0_interrupt [get_bd_pins interrupt] [get_bd_pins v_frmbuf_wr_0/interrupt]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins ISPPipeline_accel_0/ap_rst_n] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_3_Dout [get_bd_pins v_proc_ss_0/aresetn_ctrl] [get_bd_pins xlslice_2/Dout]
  connect_bd_net -net xlslice_4_Dout [get_bd_pins v_frmbuf_wr_0/ap_rst_n] [get_bd_pins xlslice_3/Dout]
...
# Hierarchical cell: pipe_1
proc create_hier_cell_pipe_1 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_pipe_1() - Empty argument(s)!"}
     return
  }
...
# Hierarchical cell: pipe_0
proc create_hier_cell_pipe_0 { parentCell nameHier } {

  variable script_folder

  if { $parentCell eq "" || $nameHier eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2092 -severity "ERROR" "create_hier_cell_pipe_0() - Empty argument(s)!"}
     return
  }
...
proc create_hier_cell_GT_Quad_and_Clk { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:display_aurora:GT_Serial_Transceiver_Pins_RX_rtl:1.0 GT_Serial_RX
  ...
  connect_bd_net -net rxn_0_1 [get_bd_pins RX_DATA_IN_rxn] [get_bd_pins gt_quad_base_1/rxn]
  connect_bd_net -net rxp_0_1 [get_bd_pins RX_DATA_IN_rxp] [get_bd_pins gt_quad_base_1/rxp]
...
proc create_hier_cell_mipi_csi_rx_ss { parentCell nameHier } {
  ...
  connect_bd_intf_net -intf_net axi_iic_1_sensor_IIC [get_bd_intf_pins IIC_sensor] [get_bd_intf_pins fmc_multicam_control/sensor_iic]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins fmc_multicam_control/S_AXI]

  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins fmc_multicam_control/Din]
  connect_bd_net -net In0_0_1 [get_bd_pins fmc_multicam_poc1_int] [get_bd_pins fmc_multicam_control/fmc_multicam_poc1_int]
  connect_bd_net -net In1_0_1 [get_bd_pins fmc_multicam_poc2_int] [get_bd_pins fmc_multicam_control/fmc_multicam_poc2_int]
  connect_bd_net -net axi_iic_1_sensor_iic2intc_irpt [get_bd_pins iic2intc_irpt] [get_bd_pins fmc_multicam_control/iic2intc_irpt]
  connect_bd_net -net clk_wizard_0_clk_out1 [get_bd_pins s_axi_aclk] [get_bd_pins fmc_multicam_control/s_axi_aclk] -boundary_type upper
  ...
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins fmc_multicam_control/s_axi_aresetn] -boundary_type upper
  ...
  connect_bd_net -net xlslice_26_Dout [get_bd_pins fmc_multicam_poc1_en] [get_bd_pins fmc_multicam_control/fmc_multicam_poc1_en]
  connect_bd_net -net xlslice_27_Dout [get_bd_pins fmc_multicam_poc2_en] [get_bd_pins fmc_multicam_control/fmc_multicam_poc2_en]
  connect_bd_net -net xlslice_28_Dout [get_bd_pins fmc_muticam_max9286_pwdn_n] [get_bd_pins fmc_multicam_control/fmc_muticam_max9286_pwdn_n]
  connect_bd_net -net xlslice_29_Dout [get_bd_pins fmc_muticam_max9296_pwdn_n] [get_bd_pins fmc_multicam_control/fmc_muticam_max9296_pwdn_n]
  connect_bd_net -net xlslice_30_Dout [get_bd_pins fmc_multicam_iic_mux_rst_n] [get_bd_pins fmc_multicam_control/fmc_multicam_iic_mux_rst_n]
...
proc create_hier_cell_cap_pipe { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 m_axi_cap_write

  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 s_axi_ctrl_cap


  # Create pins
  create_bd_pin -dir I -from 31 -to 0 Din
  create_bd_pin -dir O -type intr frm_buf_wr_intr_0
  create_bd_pin -dir O -type intr frm_buf_wr_intr_1
  create_bd_pin -dir O -type intr frm_buf_wr_intr_2
  create_bd_pin -dir O -type intr frm_buf_wr_intr_3
  create_bd_pin -dir I sc_aresetn
  create_bd_pin -dir I -type clk video_clk
  ...
  set_property -dict [ list \
   ...
   CONFIG.TDATA_REMAP {{4'b0000,tdata[23:14],tdata[11:2]}} \
  ...
  # Create instance: pipe_0
  create_hier_cell_pipe_0 $hier_obj pipe_0

  # Create instance: pipe_1
  create_hier_cell_pipe_1 $hier_obj pipe_1

  # Create instance: pipe_2
  create_hier_cell_pipe_2 $hier_obj pipe_2

  # Create instance: pipe_3
  create_hier_cell_pipe_3 $hier_obj pipe_3

  # Create instance: smartconnect_ctrl_cap, and set properties
  set smartconnect_ctrl_cap [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect smartconnect_ctrl_cap ]
  set_property -dict [ list \
   CONFIG.NUM_MI {12} \
   CONFIG.NUM_SI {1} \
 ] $smartconnect_ctrl_cap

  # Create instance: smartconnect_data_cap, and set properties
  set smartconnect_data_cap [ create_bd_cell -type ip -vlnv xilinx.com:ip:smartconnect smartconnect_data_cap ]
  set_property -dict [ list \
   CONFIG.NUM_SI {4} \
 ] $smartconnect_data_cap

  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins s_axi_ctrl_cap] [get_bd_intf_pins smartconnect_ctrl_cap/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axis_switch_0_M00_AXIS [get_bd_intf_pins axis_switch_0/M00_AXIS] [get_bd_intf_pins pipe_0/s_axis_video]
  ...
  connect_bd_intf_net -intf_net pipe_0_m_axi_mm_video [get_bd_intf_pins pipe_0/m_axi_mm_video] [get_bd_intf_pins smartconnect_data_cap/S00_AXI]
  connect_bd_intf_net -intf_net pipe_1_m_axi_mm_video [get_bd_intf_pins pipe_1/m_axi_mm_video] [get_bd_intf_pins smartconnect_data_cap/S01_AXI]
  connect_bd_intf_net -intf_net pipe_2_m_axi_mm_video [get_bd_intf_pins pipe_2/m_axi_mm_video] [get_bd_intf_pins smartconnect_data_cap/S02_AXI]
  connect_bd_intf_net -intf_net pipe_3_m_axi_mm_video [get_bd_intf_pins pipe_3/m_axi_mm_video] [get_bd_intf_pins smartconnect_data_cap/S03_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_dm_1 [get_bd_intf_pins pipe_1/s_axi_ctrl_dm] [get_bd_intf_pins smartconnect_ctrl_cap/M03_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_dm_2 [get_bd_intf_pins pipe_2/s_axi_ctrl_dm] [get_bd_intf_pins smartconnect_ctrl_cap/M06_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_dm_3 [get_bd_intf_pins pipe_3/s_axi_ctrl_dm] [get_bd_intf_pins smartconnect_ctrl_cap/M09_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_frm_b_wr_1 [get_bd_intf_pins pipe_0/s_axi_ctrl_frm_b_wr] [get_bd_intf_pins smartconnect_ctrl_cap/M02_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_frm_b_wr_2 [get_bd_intf_pins pipe_1/s_axi_ctrl_frm_b_wr] [get_bd_intf_pins smartconnect_ctrl_cap/M05_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_frm_b_wr_3 [get_bd_intf_pins pipe_2/s_axi_ctrl_frm_b_wr] [get_bd_intf_pins smartconnect_ctrl_cap/M08_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_frm_b_wr_4 [get_bd_intf_pins pipe_3/s_axi_ctrl_frm_b_wr] [get_bd_intf_pins smartconnect_ctrl_cap/M11_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_ss_1 [get_bd_intf_pins pipe_1/s_axi_ctrl_ss] [get_bd_intf_pins smartconnect_ctrl_cap/M04_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_ss_2 [get_bd_intf_pins pipe_2/s_axi_ctrl_ss] [get_bd_intf_pins smartconnect_ctrl_cap/M07_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_ss_3 [get_bd_intf_pins pipe_3/s_axi_ctrl_ss] [get_bd_intf_pins smartconnect_ctrl_cap/M10_AXI]
  connect_bd_intf_net -intf_net s_axis_video_1 [get_bd_intf_pins axis_switch_0/M01_AXIS] [get_bd_intf_pins pipe_1/s_axis_video]
  connect_bd_intf_net -intf_net s_axis_video_2 [get_bd_intf_pins axis_switch_0/M02_AXIS] [get_bd_intf_pins pipe_2/s_axis_video]
  connect_bd_intf_net -intf_net s_axis_video_3 [get_bd_intf_pins axis_switch_0/M03_AXIS] [get_bd_intf_pins pipe_3/s_axis_video]
  connect_bd_intf_net -intf_net smartconnect_0_M00_AXI [get_bd_intf_pins pipe_0/s_axi_ctrl_dm] [get_bd_intf_pins smartconnect_ctrl_cap/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_2_M00_AXI [get_bd_intf_pins m_axi_cap_write] [get_bd_intf_pins smartconnect_data_cap/M00_AXI]
  connect_bd_intf_net -intf_net smartconnect_gp0_p0p1_M01_AXI [get_bd_intf_pins pipe_0/s_axi_ctrl_ss] [get_bd_intf_pins smartconnect_ctrl_cap/M01_AXI]

  # Create port connections
  connect_bd_net -net ap_rst_n_1 [get_bd_pins video_rst_n] [get_bd_pins axis_subset_converter_0/aresetn] -boundary_type upper
  connect_bd_net -net ap_rst_n_1 [get_bd_pins video_rst_n] [get_bd_pins axis_switch_0/aresetn] -boundary_type upper
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Din] [get_bd_pins pipe_0/Din] -boundary_type upper
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Din] [get_bd_pins pipe_1/Din] -boundary_type upper
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Din] [get_bd_pins pipe_2/Din] -boundary_type upper
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins Din] [get_bd_pins pipe_3/Din] -boundary_type upper
  ...
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins axis_switch_0/aclk] -boundary_type upper
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins pipe_0/video_clk] -boundary_type upper
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins pipe_1/video_clk] -boundary_type upper
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins pipe_2/video_clk] -boundary_type upper
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins pipe_3/video_clk] -boundary_type upper
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins smartconnect_ctrl_cap/aclk] -boundary_type upper
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins video_clk] [get_bd_pins smartconnect_data_cap/aclk] -boundary_type upper
  connect_bd_net -net pipe_1_interrupt [get_bd_pins frm_buf_wr_intr_1] [get_bd_pins pipe_1/interrupt]
  connect_bd_net -net pipe_2_interrupt [get_bd_pins frm_buf_wr_intr_2] [get_bd_pins pipe_2/interrupt]
  connect_bd_net -net pipe_3_interrupt [get_bd_pins frm_buf_wr_intr_3] [get_bd_pins pipe_3/interrupt]
  connect_bd_net -net sc_aresetn_1 [get_bd_pins sc_aresetn] [get_bd_pins smartconnect_ctrl_cap/aresetn] -boundary_type upper
  connect_bd_net -net sc_aresetn_1 [get_bd_pins sc_aresetn] [get_bd_pins smartconnect_data_cap/aresetn] -boundary_type upper
  connect_bd_net -net v_frmbuf_wr_0_interrupt [get_bd_pins frm_buf_wr_intr_0] [get_bd_pins pipe_0/interrupt]
...
proc create_hier_cell_hdmi_tx_pipe { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type intr hdmi_gt_ctrl_irq
  create_bd_pin -dir O -type intr hdmi_tx_ss_irq
  create_bd_pin -dir O -type intr iic2intc_irpt
  ...
  connect_bd_net -net bufg_gt_1_usrclk [get_bd_pins GT_Quad_and_Clk/tx_usrclk] [get_bd_pins hdmi_gt_controller_1/gt_txusrclk] -boundary_type upper
  connect_bd_net -net bufg_gt_1_usrclk [get_bd_pins GT_Quad_and_Clk/tx_usrclk] [get_bd_pins hdmi_gt_controller_1/tx_axi4s_aclk] -boundary_type upper
  connect_bd_net -net bufg_gt_1_usrclk [get_bd_pins GT_Quad_and_Clk/tx_usrclk] [get_bd_pins v_hdmi_tx_ss_0/link_clk] -boundary_type upper
  ...
  connect_bd_net -net hdmi_gt_controller_1_irq [get_bd_pins hdmi_gt_ctrl_irq] [get_bd_pins hdmi_gt_controller_1/irq]
  ...
  connect_bd_net -net hdmi_tx_pipe_hdmi_tx_irq [get_bd_pins hdmi_tx_ss_irq] [get_bd_pins v_hdmi_tx_ss_0/irq]
  ...
  connect_bd_net -net net_mb_ss_0_clk_out2 [get_bd_pins aclk] [get_bd_pins tx_video_axis_reg_slice/aclk] -boundary_type upper
  connect_bd_net -net net_mb_ss_0_clk_out2 [get_bd_pins aclk] [get_bd_pins v_hdmi_tx_ss_0/s_axis_video_aclk] -boundary_type upper
  connect_bd_net -net net_mb_ss_0_dcm_locked [get_bd_pins aresetn1] [get_bd_pins tx_video_axis_reg_slice/aresetn] -boundary_type upper
  connect_bd_net -net net_mb_ss_0_dcm_locked [get_bd_pins aresetn1] [get_bd_pins v_hdmi_tx_ss_0/s_axis_video_aresetn] -boundary_type upper
  ...
  connect_bd_net -net net_mb_ss_0_peripheral_aresetn [get_bd_pins ARESETN] [get_bd_pins v_hdmi_tx_ss_0/s_axi_cpu_aresetn] -boundary_type upper
  ...
  connect_bd_net -net net_mb_ss_0_s_axi_aclk [get_bd_pins altclk] [get_bd_pins v_hdmi_tx_ss_0/s_axi_cpu_aclk] -boundary_type upper
  ...
  connect_bd_net -net rxn_0_1 [get_bd_pins RX_DATA_IN_rxn] [get_bd_pins GT_Quad_and_Clk/RX_DATA_IN_rxn]
  connect_bd_net -net rxp_0_1 [get_bd_pins RX_DATA_IN_rxp] [get_bd_pins GT_Quad_and_Clk/RX_DATA_IN_rxp]
...
proc create_hier_cell_mipi_capture_pipe { parentCell nameHier } {
  ...
  create_bd_pin -dir O -type intr csirxss_csi_irq
  create_bd_pin -dir I -type clk dphy_clk_200M
  create_bd_pin -dir O -from 0 -to 0 fmc_multicam_iic_mux_rst_n_0
  create_bd_pin -dir O -from 0 -to 0 fmc_multicam_poc1_en_0
  create_bd_pin -dir I -from 0 -to 0 fmc_multicam_poc1_int_0
  create_bd_pin -dir O -from 0 -to 0 fmc_multicam_poc2_en_0
  create_bd_pin -dir I -from 0 -to 0 fmc_multicam_poc2_int_0
  create_bd_pin -dir O -from 0 -to 0 fmc_muticam_max9286_pwdn_n_0
  create_bd_pin -dir O -from 0 -to 0 fmc_muticam_max9296_pwdn_n_0
  create_bd_pin -dir O -type intr frm_buf_wr_intr_0
  create_bd_pin -dir O -type intr frm_buf_wr_intr_1
  create_bd_pin -dir O -type intr frm_buf_wr_intr_2
  create_bd_pin -dir O -type intr frm_buf_wr_intr_3
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net S_AXIS_1 [get_bd_intf_pins cap_pipe/S_AXIS] [get_bd_intf_pins mipi_csi_rx_ss/video_out]
  connect_bd_intf_net -intf_net cap_pipe_m_axi_cap_write [get_bd_intf_pins m_axi_cap_write] [get_bd_intf_pins cap_pipe/m_axi_cap_write]
  ...
  connect_bd_intf_net -intf_net s_axi_ctrl_cap_p0p1_1 [get_bd_intf_pins s_axi_ctrl_cap] [get_bd_intf_pins cap_pipe/s_axi_ctrl_cap]
  connect_bd_intf_net -intf_net smartconnect_gp0_M04_AXI [get_bd_intf_pins S_AXI] [get_bd_intf_pins mipi_csi_rx_ss/S_AXI]

  # Create port connections
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins cap_pipe/Din] -boundary_type upper
  connect_bd_net -net Din_1 [get_bd_pins Din] [get_bd_pins mipi_csi_rx_ss/Din] -boundary_type upper
  connect_bd_net -net cap_pipe_frm_buf_wr_intr_0 [get_bd_pins frm_buf_wr_intr_0] [get_bd_pins cap_pipe/frm_buf_wr_intr_0]
  connect_bd_net -net cap_pipe_frm_buf_wr_intr_1 [get_bd_pins frm_buf_wr_intr_1] [get_bd_pins cap_pipe/frm_buf_wr_intr_1]
  connect_bd_net -net cap_pipe_frm_buf_wr_intr_2 [get_bd_pins frm_buf_wr_intr_2] [get_bd_pins cap_pipe/frm_buf_wr_intr_2]
  connect_bd_net -net cap_pipe_frm_buf_wr_intr_3 [get_bd_pins frm_buf_wr_intr_3] [get_bd_pins cap_pipe/frm_buf_wr_intr_3]
  ...
  connect_bd_net -net dphy_clk_200M_1 [get_bd_pins dphy_clk_200M] [get_bd_pins mipi_csi_rx_ss/dphy_clk_200M]
  connect_bd_net -net fmc_multicam_poc1_int_1 [get_bd_pins fmc_multicam_poc1_int_0] [get_bd_pins mipi_csi_rx_ss/fmc_multicam_poc1_int]
  connect_bd_net -net fmc_multicam_poc2_int_1 [get_bd_pins fmc_multicam_poc2_int_0] [get_bd_pins mipi_csi_rx_ss/fmc_multicam_poc2_int]
  connect_bd_net -net mipi_csi_rx_ss_csirxss_csi_irq [get_bd_pins csirxss_csi_irq] [get_bd_pins mipi_csi_rx_ss/csirxss_csi_irq]
  connect_bd_net -net mipi_csi_rx_ss_fmc_multicam_iic_mux_rst_n [get_bd_pins fmc_multicam_iic_mux_rst_n_0] [get_bd_pins mipi_csi_rx_ss/fmc_multicam_iic_mux_rst_n]
  connect_bd_net -net mipi_csi_rx_ss_fmc_multicam_poc1_en [get_bd_pins fmc_multicam_poc1_en_0] [get_bd_pins mipi_csi_rx_ss/fmc_multicam_poc1_en]
  connect_bd_net -net mipi_csi_rx_ss_fmc_multicam_poc2_en [get_bd_pins fmc_multicam_poc2_en_0] [get_bd_pins mipi_csi_rx_ss/fmc_multicam_poc2_en]
  connect_bd_net -net mipi_csi_rx_ss_fmc_muticam_max9286_pwdn_n [get_bd_pins fmc_muticam_max9286_pwdn_n_0] [get_bd_pins mipi_csi_rx_ss/fmc_muticam_max9286_pwdn_n]
  connect_bd_net -net mipi_csi_rx_ss_fmc_muticam_max9296_pwdn_n [get_bd_pins fmc_muticam_max9296_pwdn_n_0] [get_bd_pins mipi_csi_rx_ss/fmc_muticam_max9296_pwdn_n]
  ...
  connect_bd_net -net sc_aresetn_1 [get_bd_pins sc_aresetn] [get_bd_pins cap_pipe/sc_aresetn]
...
proc create_hier_cell_display_pipe { parentCell nameHier } {
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins AUDIO_IN] [get_bd_intf_pins hdmi_tx_pipe/AUDIO_IN]
  ...
  connect_bd_net -net acr_cts_1 [get_bd_pins acr_cts] [get_bd_pins hdmi_tx_pipe/acr_cts]
  connect_bd_net -net acr_n_1 [get_bd_pins acr_n] [get_bd_pins hdmi_tx_pipe/acr_n]
  connect_bd_net -net acr_valid_1 [get_bd_pins acr_valid] [get_bd_pins hdmi_tx_pipe/acr_valid]
  ...
  connect_bd_net -net clk_wizard_0_clk_out3 [get_bd_pins s_axis_aclk] [get_bd_pins hdmi_tx_pipe/aclk] -boundary_type upper
  ...
  connect_bd_net -net hdmi_tx_pipe_irq [get_bd_pins hdmi_gt_ctrl_irq] [get_bd_pins hdmi_tx_pipe/hdmi_gt_ctrl_irq]
  connect_bd_net -net hdmi_tx_pipe_irq1 [get_bd_pins hdmi_tx_ss_irq] [get_bd_pins hdmi_tx_pipe/hdmi_tx_ss_irq]
  connect_bd_net -net hdmi_tx_pipe_tx_tmds_clk [get_bd_pins tx_tmds_clk] [get_bd_pins hdmi_tx_pipe/tx_tmds_clk]
  connect_bd_net -net hdmi_tx_pipe_txn_0 [get_bd_pins txn_0] [get_bd_pins hdmi_tx_pipe/TX_DATA_OUT_txn]
  connect_bd_net -net hdmi_tx_pipe_txp_0 [get_bd_pins txp_0] [get_bd_pins hdmi_tx_pipe/TX_DATA_OUT_txp]
  connect_bd_net -net ps_gpio_1 [get_bd_pins Din] [get_bd_pins xlslice_20/Din]
  connect_bd_net -net rxn_0_1 [get_bd_pins rxn_0] [get_bd_pins hdmi_tx_pipe/RX_DATA_IN_rxn]
  connect_bd_net -net rxp_0_1 [get_bd_pins rxp_0] [get_bd_pins hdmi_tx_pipe/RX_DATA_IN_rxp]
  connect_bd_net -net s_axis_audio_aclk_1 [get_bd_pins s_axis_audio_aclk] [get_bd_pins hdmi_tx_pipe/s_axis_audio_aclk]
  connect_bd_net -net s_axis_audio_aresetn_1 [get_bd_pins s_axis_audio_aresetn] [get_bd_pins hdmi_tx_pipe/s_axis_audio_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set fmc_multicam_poc1_int [ create_bd_port -dir I -from 0 -to 0 fmc_multicam_poc1_int ]
  set fmc_multicam_poc2_en [ create_bd_port -dir O -from 0 -to 0 fmc_multicam_poc2_en ]
  set fmc_multicam_poc2_int [ create_bd_port -dir I -from 0 -to 0 fmc_multicam_poc2_int ]
  ...
  connect_bd_intf_net -intf_net CLK_IN_AUDIO_0_1 [get_bd_intf_ports CLK_IN_AUDIO] [get_bd_intf_pins audio_pipe/CLK_IN_AUDIO]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets cap_pipe_M00_AXI] [get_bd_intf_pins ${::NOC_INST_0}/S09_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_1_AXI]
  connect_bd_intf_net -intf_net csi_mipi_phy_if_1 [get_bd_intf_ports mipi_phy_csi] [get_bd_intf_pins mipi_capture_pipe/csi_mipi_phy_if]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets display_pipe_vmix_mm_axi_vid_rd_1] [get_bd_intf_pins ${::NOC_INST_0}/S10_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_2_AXI]
  connect_bd_intf_net -intf_net mipi_capture_pipe_M00_AXI [get_bd_intf_pins ${::NOC_INST_0}/S13_AXI] [get_bd_intf_pins mipi_capture_pipe/m_axi_cap_write]
connect_bd_intf_net -intf_net [get_bd_intf_nets mipi_capture_pipe_M00_AXI] [get_bd_intf_pins ${::NOC_INST_0}/S13_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_5_AXI]
  connect_bd_intf_net -intf_net mipi_csi_rx_ss_IIC_sensor [get_bd_intf_ports IIC_sensor] [get_bd_intf_pins mipi_capture_pipe/sensor_iic]
  connect_bd_intf_net -intf_net s_axi_ctrl_acr_1 [get_bd_intf_pins audio_pipe/s_axi_ctrl_acr] [get_bd_intf_pins smartconnect_gp0/M08_AXI]
  connect_bd_intf_net -intf_net s_axi_ctrl_aud_for_1 [get_bd_intf_pins audio_pipe/s_axi_ctrl_aud_for] [get_bd_intf_pins smartconnect_gp0/M09_AXI]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets smartconnect_accel_M00_AXI] [get_bd_intf_pins axi_perf_mon_0/SLOT_4_AXI] [get_bd_intf_pins smartconnect_accel1/M00_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_gp0_M06_AXI [get_bd_intf_pins mipi_capture_pipe/s_axi_ctrl_cap] [get_bd_intf_pins smartconnect_gp0/M06_AXI]
  ...
  connect_bd_net -net audio_pipe_aud_clk [get_bd_pins ${::NOC_INST_0}/aclk11] [get_bd_pins audio_pipe/aud_clk] -boundary_type upper
  connect_bd_net -net audio_pipe_aud_clk [get_bd_pins ${::NOC_INST_0}/aclk11] [get_bd_pins display_pipe/s_axis_audio_aclk] -boundary_type upper
  connect_bd_net -net audio_pipe_aud_resetn_out [get_bd_pins audio_pipe/aud_resetn_out] [get_bd_pins display_pipe/s_axis_audio_aresetn]
  ...
  connect_bd_net -net clk_wiz_clk_out3 [get_bd_pins clk_wiz/clk_out_200] [get_bd_pins mipi_capture_pipe/dphy_clk_200M] -boundary_type upper
  connect_bd_net -net clk_wiz_clk_out3 [get_bd_pins clk_wiz/clk_out_200] [get_bd_pins rst_processor_pl_200Mhz/slowest_sync_clk] -boundary_type upper
  ...
  connect_bd_net -net display_pipe_irq [get_bd_pins ${::PS_INST}/pl_ps_irq0] [get_bd_pins display_pipe/hdmi_gt_ctrl_irq]
  connect_bd_net -net display_pipe_irq1 [get_bd_pins ${::PS_INST}/pl_ps_irq1] [get_bd_pins display_pipe/hdmi_tx_ss_irq]
  connect_bd_net -net display_pipe_txn_0 [get_bd_ports TX_DATA_OUT_txn] [get_bd_pins display_pipe/txn_0]
  connect_bd_net -net display_pipe_txp_0 [get_bd_ports TX_DATA_OUT_txp] [get_bd_pins display_pipe/txp_0]
  connect_bd_net -net display_pipe_vmix_intr [get_bd_pins ${::PS_INST}/pl_ps_irq2] [get_bd_pins display_pipe/vmix_intr]
  connect_bd_net -net fmc_multicam_poc1_int_0_1 [get_bd_ports fmc_multicam_poc1_int] [get_bd_pins mipi_capture_pipe/fmc_multicam_poc1_int_0]
  connect_bd_net -net fmc_multicam_poc2_int_0_1 [get_bd_ports fmc_multicam_poc2_int] [get_bd_pins mipi_capture_pipe/fmc_multicam_poc2_int_0]
  ...
  connect_bd_net -net mipi_capture_pipe_fmc_multicam_iic_mux_rst_n_0 [get_bd_ports fmc_multicam_iic_mux_rst_n] [get_bd_pins mipi_capture_pipe/fmc_multicam_iic_mux_rst_n_0]
  connect_bd_net -net mipi_capture_pipe_fmc_multicam_poc1_en_0 [get_bd_ports fmc_multicam_poc1_en] [get_bd_pins mipi_capture_pipe/fmc_multicam_poc1_en_0]
  connect_bd_net -net mipi_capture_pipe_fmc_multicam_poc2_en_0 [get_bd_ports fmc_multicam_poc2_en] [get_bd_pins mipi_capture_pipe/fmc_multicam_poc2_en_0]
  connect_bd_net -net mipi_capture_pipe_fmc_muticam_max9286_pwdn_n_0 [get_bd_ports fmc_multicam_max9286_pwdn_n] [get_bd_pins mipi_capture_pipe/fmc_muticam_max9286_pwdn_n_0]
  connect_bd_net -net mipi_capture_pipe_fmc_muticam_max9296_pwdn_n_0 [get_bd_ports fmc_multicam_max9296_pwdn_n] [get_bd_pins mipi_capture_pipe/fmc_muticam_max9296_pwdn_n_0]
  connect_bd_net -net mipi_capture_pipe_frm_buf_wr_intr_0 [get_bd_pins ${::PS_INST}/pl_ps_irq8] [get_bd_pins mipi_capture_pipe/frm_buf_wr_intr_0]
  connect_bd_net -net mipi_capture_pipe_frm_buf_wr_intr_1 [get_bd_pins ${::PS_INST}/pl_ps_irq9] [get_bd_pins mipi_capture_pipe/frm_buf_wr_intr_1]
  connect_bd_net -net mipi_capture_pipe_frm_buf_wr_intr_2 [get_bd_pins ${::PS_INST}/pl_ps_irq10] [get_bd_pins mipi_capture_pipe/frm_buf_wr_intr_2]
  connect_bd_net -net mipi_capture_pipe_frm_buf_wr_intr_3 [get_bd_pins ${::PS_INST}/pl_ps_irq11] [get_bd_pins mipi_capture_pipe/frm_buf_wr_intr_3]
  ...
  connect_bd_net -net net_mb_ss_0_clk_out2 [get_bd_pins ${::PS_INST}/m_axi_lpd_aclk] [get_bd_pins mipi_capture_pipe/video_clk] -boundary_type upper
  ...
  connect_bd_net -net rst_processor_1_150M_interconnect_aresetn [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_vip_m0/aresetn] -boundary_type upper
  connect_bd_net -net rst_processor_1_150M_interconnect_aresetn [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins axi_vip_m1/aresetn] -boundary_type upper
  ...
  connect_bd_net -net rst_processor_1_150M_interconnect_aresetn [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins mipi_capture_pipe/sc_aresetn] -boundary_type upper
  ...
  connect_bd_net -net rst_processor_1_150M_interconnect_aresetn [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins smartconnect_accel0/aresetn] -boundary_type upper
  connect_bd_net -net rst_processor_1_150M_interconnect_aresetn [get_bd_pins axi_perf_mon_0/core_aresetn] [get_bd_pins smartconnect_accel1/aresetn] -boundary_type upper
  ...
  connect_bd_net -net rxn_0 [get_bd_ports RX_DATA_IN_rxn] [get_bd_pins display_pipe/rxn_0]
  connect_bd_net -net rxp_0_1 [get_bd_ports RX_DATA_IN_rxp] [get_bd_pins display_pipe/rxp_0]
  ...
  assign_bd_address -offset 0xA40C0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_0/ISPPipeline_accel_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA40E0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_1/ISPPipeline_accel_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA4180000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_2/ISPPipeline_accel_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA41A0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_3/ISPPipeline_accel_0/s_axi_CTRL/Reg] -force
  ...
  assign_bd_address -offset 0xA4070000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/mipi_csi_rx_ss/fmc_multicam_control/axi_iic_1_sensor/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0xA40F0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_1/v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA4190000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_2/v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA41B0000 -range 0x00010000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_3/v_frmbuf_wr_0/s_axi_CTRL/Reg] -force
  assign_bd_address -offset 0xA4020000 -range 0x00020000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs display_pipe/hdmi_tx_pipe/v_hdmi_tx_ss_0/S_AXI_CPU_IN/Reg] -force
  ...
  assign_bd_address -offset 0xA4080000 -range 0x00040000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_0/v_proc_ss_0/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0xA4100000 -range 0x00040000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_1/v_proc_ss_0/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0xA4140000 -range 0x00040000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_2/v_proc_ss_0/s_axi_ctrl/Reg] -force
  assign_bd_address -offset 0xA41C0000 -range 0x00040000 -target_address_space [get_bd_addr_spaces ${::PS_INST}/Data1] [get_bd_addr_segs mipi_capture_pipe/cap_pipe/pipe_3/v_proc_ss_0/s_axi_ctrl/Reg] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/pipe_0/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::NOC_INST_0}/S13_AXI/C1_DDR_LOW0x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/pipe_1/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::NOC_INST_0}/S13_AXI/C1_DDR_LOW0x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/pipe_2/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::NOC_INST_0}/S13_AXI/C1_DDR_LOW0x2] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/pipe_3/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::NOC_INST_0}/S13_AXI/C1_DDR_LOW0x2] -force
  ...
  assign_bd_address -offset 0x050000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/pipe_0/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::NOC_INST_0}/S13_AXI/C1_DDR_CH1x2] -force
  assign_bd_address -offset 0x050000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/pipe_1/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::NOC_INST_0}/S13_AXI/C1_DDR_CH1x2] -force
  assign_bd_address -offset 0x050000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/pipe_2/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::NOC_INST_0}/S13_AXI/C1_DDR_CH1x2] -force
  assign_bd_address -offset 0x050000000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces mipi_capture_pipe/cap_pipe/pipe_3/v_frmbuf_wr_0/Data_m_axi_mm_video] [get_bd_addr_segs ${::NOC_INST_0}/S13_AXI/C1_DDR_CH1x2] -force
  ...
  set_property PFM_NAME {xilinx.com:xd:vck190_base_trd_platform2:1.0} [get_files [current_bd_design].bd]
  ...
  set_property PFM.AXI_PORT {} [get_bd_cells /${::NOC_INST_0}]
  set_property PFM.AXI_PORT {S01_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S02_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S03_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S04_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S05_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S06_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S07_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S08_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S09_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S10_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S11_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S12_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S13_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S14_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"} S15_AXI {memport "MIG" sptag "NOC_pl" memory "NOC_0 C3_DDR_LOW0x2"}} [get_bd_cells /smartconnect_accel0]
  set_property PFM.AXI_PORT {S01_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S02_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S03_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S04_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S05_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S06_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S07_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S08_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S09_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S10_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S11_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S12_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S13_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S14_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"} S15_AXI {memport "MIG" sptag "NOC_aie" memory "NOC_0 C0_DDR_LOW0x2"}} [get_bd_cells /smartconnect_accel1]
